...
public class IronSourceController : MonoBehaviour, AdsProvider
{
    //app key
    ...
    public void LoadInterstitial(Action<bool> loadComplete = null)
    {
        ...
        NetworkDetector.instance.checkInternetConnection((reachedInternet) =>
          {
              if (reachedInternet)
                  IronSource.Agent.loadInterstitial();
          }, false, false);
