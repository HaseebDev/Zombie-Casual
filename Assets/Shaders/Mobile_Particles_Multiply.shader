  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat16_1 = (u_xlat10_0.w * in_f.color.w);
          u_xlat16_0 = ((u_xlat10_0 * in_f.color) + float4(-1, (-1), (-1), (-1)));
          out_f.color = ((float4(u_xlat16_1, u_xlat16_1, u_xlat16_1, u_xlat16_1) * u_xlat16_0) + float4(1, 1, 1, 1));
          return out_f;
      }
