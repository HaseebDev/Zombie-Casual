...
//#else
                    try
                    {
                        ...
                        Load(s);// new FileStream(path, FileMode.Open, FileAccess.Read));
                        _succeeded = true;
                    }
                    catch (Exception e)
                    {
...
//#endif
        ...
        class LoadMetaTask : LoadAtPathTask
        {
            ...
            public override string path => $"{targetFolder}/{metaFileName}";
        ...
        class LoadLanguageTask : LoadAtPathTask
        {
            ...
            public override bool canceled => _canceled;
            public override string path => $"{targetFolder}/{_languageType}";
