...
namespace CustomListView.Weapon
{
    ...
    public class WeaponGridAdapter : GridAdapter<GridParams, WeaponItemViewHolder>
    {
        // Helper that stores data and notifies the adapter when items count changes
        // Can be iterated and can also have its elements accessed by the [] operator
        public SimpleDataHelper<WeaponItemModel> Data { get; private set; }
        ...
        {
            Data = new SimpleDataHelper<WeaponItemModel>(this);
        ...
        protected override void UpdateCellViewsHolder(WeaponItemViewHolder newOrRecycled)
        {
            ...
            */
            ...
            WeaponItemModel model = Data[newOrRecycled.ItemIndex];
        ...
        */
        ...
        public void AddItemsAt(int index, IList<WeaponItemModel> items)
        {
        ...
        public void SetItems(IList<WeaponItemModel> items)
        {
        ...
        IEnumerator FetchMoreItemsFromDataSourceAndUpdate(int count)
        {
            ...
            var newItems = new WeaponItemModel[count];
        ...
        void OnDataRetrieved(WeaponItemModel[] newItems)
        {
            //Commented: this only works with Lists. ATM, Insert for Grids only works by manually changing the list and calling NotifyListChangedExternally() after
    ...
    {
        public Action<WeaponData> _onClick;
        ...
        public WeaponItemModel(WeaponData weaponData, WeaponDesign weaponDesign, Action<WeaponData> onClick,
            bool showReminder = false, bool showHighlight = false, bool isSelected = false)
        {
            _onClick = onClick;
        ...
        public void Update(WeaponItemModel weaponItemModel)
        {
            ...
            this.showHighlight = weaponItemModel.showHighlight;
            this.isSelected = weaponItemModel.isSelected;
        }
    }
    ...
    public class WeaponItemViewHolder : CellViewsHolder
    {
        public ChangeWeaponButton WeaponButton;
        ...
        {
            base.CollectViews();
            WeaponButton = root.GetComponent<ChangeWeaponButton>();
        ...
        public void UpdateView(WeaponItemModel model)
        {
            if (WeaponButton != null && model != null)
            {
                ...
                WeaponButton.ShowHighlight(model.showHighlight);
            }
        }
