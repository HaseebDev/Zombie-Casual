...
namespace CustomListView.WeaponFusion
{
    // There is 1 important callback you need to implement, apart from Start(): UpdateCellViewsHolder()
    // See explanations below
    public class WeaponHUDFusionGridAdapter : GridAdapter<GridParams, WeaponHUDFusionViewHolder>
    {
        // Helper that stores data and notifies the adapter when items count changes
        // Can be iterated and can also have its elements accessed by the [] operator
        public SimpleDataHelper<WeaponHUDFusionItemModel> Data { get; private set; }
        ...
        {
            Data = new SimpleDataHelper<WeaponHUDFusionItemModel>(this);
        ...
        protected override void UpdateCellViewsHolder(WeaponHUDFusionViewHolder newOrRecycled)
        {
            ...
            */
            WeaponHUDFusionItemModel model = Data[newOrRecycled.ItemIndex];
        ...
        */
        ...
        public void AddItemsAt(int index, IList<WeaponHUDFusionItemModel> items)
        {
        ...
        public void SetItems(IList<WeaponHUDFusionItemModel> items)
        {
        ...
        IEnumerator FetchMoreItemsFromDataSourceAndUpdate(int count)
        {
            ...
            var newItems = new WeaponHUDFusionItemModel[count];
        ...
        void OnDataRetrieved(WeaponHUDFusionItemModel[] newItems)
        {
            //Commented: this only works with Lists. ATM, Insert for Grids only works by manually changing the list and calling NotifyListChangedExternally() after
    ...
    public class WeaponHUDFusionItemModel
    {
        ...
        public WeaponHUDFusionItemModel(WeaponData weaponData, WeaponDesign weaponDesign,
            Action<WeaponData, WeaponDesign, EquipmentUI> onClick)
        {
        ...
        public void Update(WeaponHUDFusionItemModel weaponItemModel)
        {
            _onClick = weaponItemModel._onClick;
            _weaponData = weaponItemModel._weaponData;
            _weaponDesign = weaponItemModel._weaponDesign;
            isLocked = weaponItemModel.isLocked;
            isSelected = weaponItemModel.isSelected;
        }
    }
    ...
    public class WeaponHUDFusionViewHolder : CellViewsHolder
    {
        /*
        public Text titleText;
        public Image backgroundImage;
        */
        public EquipmentFusionUI WeaponButton;
        ...
        {
            base.CollectViews();
            WeaponButton = root.GetComponent<EquipmentFusionUI>();
        ...
        public void UpdateView(WeaponHUDFusionItemModel model)
        {
            if (WeaponButton != null && model != null)
            {
                ...
                WeaponButton.SetIsLocked(model.isLocked);
                WeaponButton.SetIsSelected(model.isSelected);
            }
        }
